...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in agent_comm_pb2_grpc.py depends on'
...
class AgentCommStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamMessages = channel.stream_stream(
                '/agentcomm.AgentComm/StreamMessages',
                request_serializer=agent__comm__pb2.AgentMessage.SerializeToString,
                response_deserializer=agent__comm__pb2.AgentMessage.FromString,
...
def add_AgentCommServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StreamMessages': grpc.stream_stream_rpc_method_handler(
                    ...
                    request_deserializer=agent__comm__pb2.AgentMessage.FromString,
                    response_serializer=agent__comm__pb2.AgentMessage.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'agentcomm.AgentComm', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('agentcomm.AgentComm', rpc_method_handlers)
...
class AgentComm(object):
    ...
    def StreamMessages(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/agentcomm.AgentComm/StreamMessages',
            agent__comm__pb2.AgentMessage.SerializeToString,
            agent__comm__pb2.AgentMessage.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
